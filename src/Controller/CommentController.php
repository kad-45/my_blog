...
class CommentController extends AbstractController
{
    ...
    public function add(Request $request, EntityManagerInterface $em, UserRepository $userRepo, ArticleRepository $articleRepo, CommentRepository $commentRepo): Response
    {
